reactions = {
    ...
    'He(gnd) + He(gnd) + He(*) -> He2(*) + He(gnd)',                        '8.1E-48*T*11600*exp(-650/(T*11600))'; % R9 - ok Martens 2009 R15
    'e + He(gnd) + He2(+,X) -> He2(*) + He(gnd)',                           '5E-39*T/Te'; % R10 (duplicato di R4)
    % Penning 1
    'He2(*) + He(*) -> He(+,gnd) + e + He(gnd) + He(gnd)',                  '0.3 * 2.9E-15*sqrt(T/0.025)'; % R11
    'He2(*) + He(*) -> He2(+,X) + e + He(gnd)',                             '0.7 * 2.9E-15*sqrt(T/0.025)'; % R12
    % Penning 2
    'He(*) + He(*) -> He(+,gnd) + e + He(gnd)',                             '0.3 * 2.9E-15*sqrt(T/0.025)' % R13 - ok Martens 2009 R16
    'He(*) + He(*) -> He2(+,X) + e',                                        '0.7 * 2.9E-15*sqrt(T/0.025)' % R14 - ok Martens 2009 R17
    % Penning 3
    'He2(*) + He2(*) -> He(+,gnd) + e + He(gnd) + He(gnd) + He(gnd)',       '0.3 * 2.9E-15*sqrt(T/0.025)' % R15
    'He2(*) + He2(*) -> He2(+,X) + e + He(gnd) + He(gnd)',                  '0.7 * 2.9E-15*sqrt(T/0.025)' % R16 - ok Martens 2009 R20
    % mol metastable iz
