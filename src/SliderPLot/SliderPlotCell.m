...
uicontrol(fig, ...
    ...
    'Units','normalized', ...
    'Position',[0.005 0.915 0.05 0.08], ...
    'Value',out_pp.ns+1,...
...
ed_ylim_inf = uicontrol(fig,"Style","edit","Units","normalized","Position",[0.005,0.83,0.05,0.04],"String",sprintf("%.2e",min(out_pp.y_nodes)));
ed_ylim_sup = uicontrol(fig,"Style","edit","Units","normalized","Position",[0.005,0.87,0.05,0.04],"String",sprintf("%.2e",max(out_pp.y_nodes)));
